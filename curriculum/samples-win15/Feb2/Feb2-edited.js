...
function printIfBig(val) {
    if (val>5) console.log(val);
}
var arr = [4.4,7,9.1,2,0,4.1,9.8,1,200];
arr.sort(compare);
arr.forEach(printIfBig)

var doubles = arr.map(double)
doubles
/*
8.8,14,18.2,4,0,8.2,19.6,2,400
*/
/*
8.8,14,18.2,4,0,8.2,19.6,2,400
*/
