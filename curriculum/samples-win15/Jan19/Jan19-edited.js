...
duck.canWalk = true;
duck.canFly = true;
duck.ducklings = [{name:"huey"}, {name:"dewey"}];
...
// Preferred:
var arr = [];
var arr = new Array('a','b','7','banana', true);
...
for (var prop in nest){
    console.log(nest[prop].noise);
}

var tom = {power:'superbikespeed'};
var dan = {power:'superobfuscation'};
